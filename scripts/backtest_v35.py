...
ckpt = torch.load("/home/user/RabitPropfim/models_saved/best_v35_stage1.pt", map_location=device, weights_only=False)
m = PPOActorCritic().to(device)
m.load_state_dict(ckpt["model_state_dict"])
m.eval()
print(f"V3.5 Stage 1 loaded (step={ckpt.get('step', 0)})")
